...
engine = create_engine("postgresql://postgres:1967@localhost:5432/records_db")
engine_dataset = create_engine("postgresql://postgres:1967@localhost:5432/datasets_db")
...
#We are using parameters to avoid sql-injection
#Also, to load multiple values:
